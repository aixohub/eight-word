...
class TenGodTrunkTable:
    ...
    又如辛金日干,遇乙木。辛为阴金，乙为阴木,辛金能克乙木，乙乃我克而阴见阴，即偏财也,
    特立表于后,以便检查。
    '日干', '伤官', '食柛', '正官', '七杀', '正财', '偏财', '正印', '偏印', '劫财', '比肩'
     [ '甲', '乙', '丙', '丁', '戊', '己', '庚', '辛', '壬', '癸']
    """
    ...
    def __init__(self):
        ...
        table_data = [['甲', '比肩', '劫财', '食柛', '伤官', '偏财', '正财', '七杀', '正官', '偏印', '正印'],
                      ['乙', '劫财', '比肩', '伤官', '食柛', '正财', '偏财', '正官', '七杀', '正印', '偏印'],
                      ['丙', '偏印', '正印', '比肩', '劫财', '食柛', '伤官', '偏财', '正财', '七杀', '正官'],
                      ['丁', '正印', '偏印', '劫财', '比肩', '伤官', '食柛', '正财', '偏财', '正官', '七杀'],
                      ['戊', '七杀', '正官', '偏印', '正印', '比肩', '劫财', '食柛', '伤官', '偏财', '正财'],
                      ['己', '正官', '七杀', '正印', '偏印', '劫财', '比肩', '伤官', '食柛', '偏财', '偏财'],
                      ['庚', '偏财', '正财', '七杀', '正官', '偏印', '正印', '比肩', '劫财', '食柛', '伤官'],
                      ['辛', '正财', '偏财', '正官', '七杀', '正印', '偏印', '劫财', '比肩', '伤官', '食柛'],
                      ['壬', '食柛', '伤官', '偏财', '正财', '七杀', '正官', '偏印', '正印', '比肩', '劫财'],
                      ['癸', '伤官', '食柛', '正财', '偏财', '正官', '七杀', '正印', '偏印', '劫财', '比肩']
                      ]
...
class TenGodBranchTable:
    ...
    def __init__(self):
        ...
        table_data = [
            ['甲', '正印', '正财', '比肩', '劫财', '偏财', '食柛', '伤官', '正财', '七杀', '正官', '偏财', '偏印'],
            ['乙', '偏印', '偏财', '劫财', '比肩', '正财', '伤官', '食柛', '偏财', '正官', '七杀', '正财', '正印'],
            ['丙', '正官', '伤官', '偏印', '正印', '食柛', '比肩', '劫财', '伤官', '偏财', '正财', '食柛', '七杀'],
            ['丁', '七杀', '食柛', '正印', '偏印', '伤官', '劫财', '比肩', '食柛', '正财', '偏财', '伤官', '正官'],
            ['戊', '正财', '劫财', '七杀', '正官', '比肩', '偏印', '正印', '劫财', '食柛', '伤官', '比肩', '偏财'],
            ['己', '偏财', '比肩', '正官', '七杀', '劫财', '正印', '偏印', '比肩', '伤官', '食柛', '劫财', '正财'],
            ['庚', '伤官', '正印', '偏财', '正财', '偏印', '七杀', '正官', '正印', '比肩', '劫财', '偏印', '食柛'],
            ['辛', '食柛', '偏印', '正财', '偏财', '正印', '正官', '七杀', '偏印', '劫财', '比肩', '正印', '伤官'],
            ['壬', '劫财', '正官', '食柛', '伤官', '七杀', '偏财', '正财', '正官', '偏印', '正印', '七杀', '比肩'],
            ['癸', '比肩', '七杀', '伤官', '食柛', '正官', '正财', '偏财', '七杀', '正印', '偏印', '正官', '劫财']
        ]
        table = pd.DataFrame(table_data, columns=table_header)
        table.set_index("日干", inplace=True)
